...
class EditProfilePage extends StatelessWidget {
  ...
  changeProfilePhoto(BuildContext parentContext) {
    return   showDialog(
        context: parentContext,builder: (_) => FlareGiffyDialog(
      ...
      description: Text('this feature is not available right now',
  ...
  applyChanges() {
    Firestore.instance
      ...
      "looking":lookingController.text,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          tallController.text=user.tall;
          lookingController.text=user.looking;
              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    buildTextField(name: "What are you looking for male/female ? ", controller: lookingController),
                    buildTextField(name: "How tall are you ? ", controller: tallController),
                  ],
                ),
              ),
              Padding(
