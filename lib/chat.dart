...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.id, @required this.peerId, @required this.peerName, @required this.peerAvatar}) : super(key: key);
...
class ChatScreen extends StatefulWidget {
  ...
  @override
  State createState() => new ChatScreenState(id: id, peerId: peerId, peerAvatar: peerAvatar);
}
